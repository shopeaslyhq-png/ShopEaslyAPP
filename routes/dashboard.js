...
router.get('/', (req, res) => {
  ...
  res.render('layout', { body: `<h1>Dashboard</h1><table class='dashboard-table'><thead><tr><th>ID</th><th>Item</th><th>Quantity</th><th>Price</th></tr></thead><tbody>${orderList}</tbody></table>` });
});
