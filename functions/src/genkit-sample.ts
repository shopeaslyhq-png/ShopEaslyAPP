...
export const menuSuggestion = onCallGenkit({
  ...
  // tokens dictionary) and the request data. The isSignedIn() and
  // hasClaim() helpers can be used to simplify. The following will require
  // the user to have the email_verified claim, for example.
